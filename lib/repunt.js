...
var Repunt = function (options) {
    options = _.defaults({},options,{
        connections:8, 
        request: request,
        createRequestOptions: function (task, defaultOptions) { return defaultOptions; }
    });
    ...
    this.filters.addFinal({
        ...
        init: function (task, next) {
            ...
            var requestOptions = {uri: task.url};
            requestOptions = options.createRequestOptions(task, requestOptions) || requestOptions;
            task.request = options.request(requestOptions, function (error, response, body) {
